---
name: msj-introduction
description: >
  Use this skill to draft the Introduction of a Motion for Summary Judgment: who moves, the judgment sought, the claims targeted, and a compact preview of why the record entitles the movant to judgment as a matter of law.
---

# Skill: MSJ — Introduction

> **PLACEHOLDER SKILL CONTENT.** This file defines the Introduction section's
...
Draft the **Introduction** section of a Motion for Summary Judgment for a
...
1. Identify the moving party, the opposing party, and the posture from the
   case documents and matter context.
2. State the relief sought: summary judgment (or partial summary judgment)
   and on which counts.
3. Preview, in one to two paragraphs, the two or three decisive grounds --
   each grounded in the record, none argued in depth here.
4. Keep it short: an Introduction is a map, not the argument.
