---
name: msj-legal-standards
description: >
  Use this skill to draft the Legal Standards section of a Motion for Summary Judgment: the summary-judgment standard and the substantive frameworks governing the targeted employment claims.
---

# Skill: MSJ — Legal Standards

> **PLACEHOLDER SKILL CONTENT.** This file defines the Legal Standards section's
...
Draft the **Legal Standards** section of a Motion for Summary Judgment for a
...
1. State the summary-judgment standard for the forum, using supplied
   authority only; otherwise [AUTHORITY NEEDED: summary judgment standard].
2. For each targeted claim (from the Statement of Claim(s) draft when
   available), set out the governing substantive framework -- e.g.
   burden-shifting for discrimination claims -- again using only supplied
   authority, with [AUTHORITY NEEDED] placeholders where none was supplied.
3. Keep this section framework-only: no application to the facts here.
4. Mirror the claim order used in the Statement of Claim(s).
