...
name: msj-analysis
description: >
  Use this skill to draft the Analysis (Argument) of a Motion for Summary Judgment: applying the legal standards to the undisputed facts, claim by claim, element by element.
---

# Skill: MSJ — Analysis

> **PLACEHOLDER SKILL CONTENT.** This file defines the Analysis section's
...
Draft the **Analysis** section of a Motion for Summary Judgment for a
...
1. For each targeted claim, apply the framework from the Legal Standards
   draft to the facts of the SUMF draft (both provided in context when
   drafted), citing SUMF paragraphs and record documents via the citation
   contract.
2. Argue element by element why no genuine dispute of material fact exists
   and why the movant prevails as a matter of law.
3. Anticipate and answer the strongest opposing arguments the record makes
   available; where the record is thin, flag rather than overreach.
4. Use argumentative headings per claim (e.g. "II.A. Count I fails because
   ...").
